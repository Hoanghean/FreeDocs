        ...
        div.innerHTML = `
            ...
            <div class="mt-2 flex space-x-2">
                ${isFolder ? 
                    ...
                    <a target="_blank" href="https://drive.google.com/file/d/${file.id}" class="bg-orange-500 text-white px-3 py-1 rounded-md text-sm hover:bg-orange-600 flex items-center download-button">
